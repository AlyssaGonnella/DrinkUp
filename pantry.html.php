...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body> 
    ...
    $query = "SELECT * FROM InPantry WHERE userID = '$user'";
...
?>
    ...
    <form action="addingredient.html.php" method="post">
    <div><label for="name">Ingredient Name:
	<input type="text" name="name" id=:"name"/></label>
    </div>
    <div><input type="submit" value="ACQUIRE INGREDIENT"/></div>
    </form>
